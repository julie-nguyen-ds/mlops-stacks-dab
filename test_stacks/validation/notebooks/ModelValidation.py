...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``test_stacks/databricks-resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in test_stacks/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in test_stacks/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text("model_name", "dev-test_stacks-model", "Model Name")
