...
[ML Config](../test_stacks/databricks-resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore test_stacks/databricks-resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://eastus2.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://eastus2.azuredatabricks.net#setting/accounts). If
...
Follow the instructions in [test_stacks/databricks-resources/README.md](../test_stacks/databricks-resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../test_stacks/databricks-resources/README.md)  to propose, test, and deploy
