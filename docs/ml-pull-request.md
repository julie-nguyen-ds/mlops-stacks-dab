...
Opening a pull request will trigger a[workflow](../.github/workflows/test_stacks-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://eastus2.azuredatabricks.net#mlflow/models/staging-test_stacks-model)
* [Prod workspace registered model](https://eastus2.azuredatabricks.net#mlflow/models/prod-test_stacks-model)
