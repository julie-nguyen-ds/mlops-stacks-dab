...
```
test_stacks         <- Root directory. Both monorepo and polyrepo are supported.
│
├── test_stacks       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
